...
const Home = () => {
  ...
  return (
    ...
    <div class="bubble"></div>
        ...
        <section id="skills">
        <h1 style={{fontSize:"50px",fontWeight:"bolder",marginBottom:"15px"}}>My Skills</h1>
  ...
  return(
    <div className="move-up">
      <img src={el} alt={el} />
        ...
        <section id="project" data-aos="flip" >
          <h1 style={{fontSize:"50px",fontWeight:"bolder",marginBottom:"15px"}}>My Projects</h1>
          <ProjectCarousal/>
          <button className="all_git_btn" style={{margin:"auto",marginTop:"5px"}}>View All</button>
        </section>
