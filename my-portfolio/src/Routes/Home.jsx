    ...
    <>
      ...
      <div className="main-content ">
        ...
        <section id="project" data-aos="fade">
          ...
          >
            <a href="https://github.com/ankit2341?tab=stars" target="_blank">View All</a>
          </button>
        </section>
        <div
        ...
        <section id="contact" className="contact" >
          ...
          <div class="contact-content" data-aos="fade-up">
            <div class="contact-form">
              ...
              <form
                action="mailto:ankitpatil2341@gmail.com"
                method="post"
                enctype="text/plain"
              >
                <fieldset>
            ...
            <div class="contact-info">
              <h3>Email Me At </h3>
              <a href="mailto:npeel3497@gmail.com">
                <p>ankitpatil2341@gmail.com</p>
              </a>
              <h3>Call Me At</h3>
              <a href="#">
                <p>+917972592414</p>
        ...
        <footer class="footer-distributed">
          <div class="footer-left">
            ...
            >
              {" "}
              <span style={{ color: "#3e64ff" }}>A</span>nkit{" "}
              <span style={{ color: "#3e64ff" }}>P</span>atil
            </h3>
          ...
          <div class="footer-center">
            ...
            <div>
              ...
              <p>
                <a href="mailto:ankitpatil2341@gmail.com">
